...
{
    public partial class RegistrarExtruidoForm : Form
    {
        double _kgEntrada;
        double _kgSalida;
        ...
        void CalcularButton_Click(object sender, EventArgs e)
        {
            ...
            _kgSalida = _piezasBuenas * _pesoProm;
        ...
        void GuardarButton_Click(object sender, EventArgs e)
        {
            ...
            if (MezclaRadio.Checked)
            {
                ...
                saveSuccess =
                    GlobalConfig.Connection.PlasticProduction_CreateExtruido(orden, _mezclaEntrada, _materialSalida);
            }
            else
            {
                orden.MaterialEntra = _materialEntrada.Nombre;
                saveSuccess =
                    GlobalConfig.Connection.PlasticProduction_CreateExtruido(orden, _materialEntrada, _materialSalida);
            }
            ...
            if (saveSuccess)
            {
                ...
                GetMateriales();
                GetMazos();
                MsgBox.Text = "Extruido registrado con éxito.";
                MsgBox.IconColor = Color.DarkGreen;
            }
            else
            {
                MsgBox.Text = "Error al registrar extruido.";
                MsgBox.IconColor = Color.DarkRed;
            }
        ...
        void GetMazos()
        {
            ...
            var materiales = GlobalConfig.Connection.Material_GetByAreaCat("Plásticos", "Extruido");
