    ...
    public partial class RegistrarExtruídoForm : Form
    {
        ...
        void GuardarButton_Click(object sender, EventArgs e)
        {
            ...
            if (MezclaRadio.Checked)
            {
                ...
                {
                    _materialSalida = new MaterialModel(SalidaCombo.Text, "Plásticos", "Extruído", _piezasBuenas);
                }
                else
                {
                ...
                saveSuccess =
                    GlobalConfig.Connection.PlasticProduction_CreateExtruído(orden, _mezclaEntrada, _materialSalida);
            }
            else
            {
                ...
                orden.MaterialSale = _materialSalida.Nombre;
                saveSuccess =
                    GlobalConfig.Connection.PlasticProduction_CreateExtruído(orden, _materialEntrada, _materialSalida);
            }
            ...
            if (saveSuccess)
            {
                ClearForm();
                GetMazos();
                MsgBox.Text = "Extruído registrado con éxito.";
                MsgBox.IconColor = Color.DarkGreen;
            }
            else
            {
                MsgBox.Text = "Error al registrar extruído.";
                MsgBox.IconColor = Color.DarkRed;
            }
