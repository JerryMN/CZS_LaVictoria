...
namespace CZS_LaVictoria_Library.DataAccess
{
    public interface IDataConnection
    {
        ...
        /// </summary>
        /// <param name="model">
        ///     Un modelo de línea de orden de compra del cual
        ///     se hace la recepción.
        /// </param>
        ...
        /// </summary>
        /// <param name="model">
        ///     Un modelo de línea de orden de venta del cual
        ///     se hace la entrega.
        /// </param>
        ...
        /// <returns>True, si se creó correctamente, falso si no.</returns>
        bool PlasticProduction_CreateMolido(ProducciónPlásticosModel model, MaterialModel materialEntrada,
        ...
        /// <param name="materialSalida">Un modelo con las propiedades del material de salida del proceso.</param>
        /// <returns>True, si se creó correctamente, falso si no.</returns>
        bool PlasticProduction_CreateCortado(ProducciónPlásticosModel model, MaterialModel materialEntrada,
            MaterialModel materialSalida);
        ...
        /// <param name="materialSalida">Un modelo con las propiedades del material de salida del proceso.</param>
        /// <returns>True, si se creó correctamente, falso si no.</returns>
        bool PlasticProduction_CreateInyección(ProducciónPlásticosModel model, MezclaModel mezcla,
            MaterialModel materialSalida);
        ...
        /// <param name="materialSalida">Un modelo con las propiedades del material de salida del proceso.</param>
        /// <returns>True, si se creó correctamente, falso si no.</returns>
        bool PlasticProduction_CreateInyección(ProducciónPlásticosModel model, MaterialModel materialEntrada,
            MaterialModel materialSalida);
